...
void Triangle::read(istream& ins) {
	...
	Triangle(vertexOne, vertexOneColor, vertexTwo, vertexTwoColor, vertexThree, vertexThreeColor);
	if (ins.fail()) {
		ins.clear();
		ins >> vertexOne >> vertexTwo >> vertexThree >> vertexThreeColor;
		Triangle(vertexOne, vertexTwo, vertexThree, vertexThreeColor);
	}
